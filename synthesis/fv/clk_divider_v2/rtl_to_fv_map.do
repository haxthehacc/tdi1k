...
# Generated on: Wed May 06 19:22:45 CEST 2026 (Wed May 06 17:22:45 UTC 2026)
...
set logfile fv/clk_divider_v2/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/clk_divider_v2 -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/ruby22.ivcs/P4/prasady/ruby_A0.p4/dv_regression.work/units/psvp/tdi1k/rtl/clk_divider_v2.v
elaborate_design -golden -root {clk_divider_v2} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/clk_divider_v2/fv_map.v.gz
elaborate_design -revised -root {clk_divider_v2}
...
#add_name_alias fv/clk_divider_v2/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.clk_divider_v2.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.clk_divider_v2.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.clk_divider_v2.rtl.fv_map.rpt
