...
# Generated by Genus(TM) Synthesis Solution 22.15-s086_1, revision 1.568.2
# Generated on: Wed May 06 19:26:23 CEST 2026 (Wed May 06 17:26:23 UTC 2026)
...
set logfile fv/row_sequencer_v2/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/row_sequencer_v2 -revised fv_map
...
set env(RC_VERSION)     "22.15-s086_1"
set env(CDN_SYNTH_ROOT) "/opt/CDN_DDI/DDI2235/CEN/GENUS221/tools.lnx86"
set CDN_SYNTH_ROOT      "/opt/CDN_DDI/DDI2235/CEN/GENUS221/tools.lnx86"
set env(CW_DIR) "/opt/CDN_DDI/DDI2235/CEN/GENUS221/tools.lnx86/lib/chipware"
set CW_DIR      "/opt/CDN_DDI/DDI2235/CEN/GENUS221/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /opt/CDN_DDI/DDI2235/CEN/GENUS221/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/opt/CDN_DDI/DDI2235/CEN/GENUS221/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/opt/CDN_DDI/DDI2235/CEN/GENUS221/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/opt/CDN_DDI/DDI2235/CEN/GENUS221/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/opt/CDN_DDI/DDI2235/CEN/GENUS221/tools.lnx86/lib/chipware/sim"
}
...
add_search_path /home/ruby22.ivcs/P4/prasady/ruby_A0.p4/dv_regression.work/units/psvp/scl180/stdcell/fs120/6M1L/liberty/lib_flow_ss -library -both
read_library -liberty -both \
    /home/ruby22.ivcs/P4/prasady/ruby_A0.p4/dv_regression.work/units/psvp/scl180/stdcell/fs120/6M1L/liberty/lib_flow_ss/tsl18fs120_scl_ss.lib
...
add_search_path /home/ruby22.ivcs/P4/prasady/ruby_A0.p4/dv_regression.work/units/psvp/tdi1k/rtl -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/ruby22.ivcs/P4/prasady/ruby_A0.p4/dv_regression.work/units/psvp/tdi1k/rtl/row_sequencer_v2.v
elaborate_design -golden -root {row_sequencer_v2} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/row_sequencer_v2/fv_map.v.gz
elaborate_design -revised -root {row_sequencer_v2}
...
#add_name_alias fv/row_sequencer_v2/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.row_sequencer_v2.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.row_sequencer_v2.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.row_sequencer_v2.rtl.fv_map.rpt
